...
;
  ...
  String toJson() => name;
  static AdvanceBotTurnResultStatePlayersSeat fromJson(String json) => values.byName(json);
}
...
class AdvanceBotTurnResultStatePlayers {
  ...
  factory AdvanceBotTurnResultStatePlayers.fromJson(Map<String, dynamic> json) {
    return AdvanceBotTurnResultStatePlayers(
      ...
      seat: AdvanceBotTurnResultStatePlayersSeat.fromJson(json['seat'] as String),
  ...
  @override
  int get hashCode => Object.hash(id, name, classKey, sprite, color, seat, isHuman, userId, hp, slot);

  @override
  String toString() => 'AdvanceBotTurnResultStatePlayers(id: $id, name: $name, classKey: $classKey, sprite: $sprite, color: $color, seat: $seat, isHuman: $isHuman, userId: $userId, hp: $hp, slot: $slot)';
}
...
;
  ...
  String toJson() => name;
  static AdvanceBotTurnResultStateRoomPhase fromJson(String json) => values.byName(json);
}
...
;
  ...
  String toJson() => name;
  static AdvanceBotTurnResultStatePhase fromJson(String json) => values.byName(json);
}
...
class AdvanceBotTurnResultStateLastRoll {
  ...
  factory AdvanceBotTurnResultStateLastRoll.fromJson(Map<String, dynamic> json) {
  ...
  @override
  int get hashCode => Object.hash(value, sprite, color, dc, success, actor, action);

  @override
  String toString() => 'AdvanceBotTurnResultStateLastRoll(value: $value, sprite: $sprite, color: $color, dc: $dc, success: $success, actor: $actor, action: $action)';
}
...
;
  ...
  String toJson() => name;
  static AdvanceBotTurnResultStateLogKind fromJson(String json) => values.byName(json);
}
...
class AdvanceBotTurnResultStateLog {
  ...
  @override
  String toString() => 'AdvanceBotTurnResultStateLog(kind: $kind, who: $who, text: $text, color: $color)';
}
...
class AdvanceBotTurnResultState {
  ...
  factory AdvanceBotTurnResultState.fromJson(Map<String, dynamic> json) {
    return AdvanceBotTurnResultState(
      ...
      players: (json['players'] as List<dynamic>).map((e) => AdvanceBotTurnResultStatePlayers.fromJson(e as Map<String, dynamic>)).toList(),
      roomPhase: AdvanceBotTurnResultStateRoomPhase.fromJson(json['roomPhase'] as String),
      ...
      dc: json['dc'] as num,
      lastRoll: json['lastRoll'] != null ? AdvanceBotTurnResultStateLastRoll.fromJson(json['lastRoll'] as Map<String, dynamic>) : null,
      log: (json['log'] as List<dynamic>).map((e) => AdvanceBotTurnResultStateLog.fromJson(e as Map<String, dynamic>)).toList(),
  ...
  @override
  int get hashCode => Object.hash(version, gameId, scenario, dmName, players, roomPhase, endsAt, turnIndex, round, phase, dc, lastRoll, log, inventory, options);

  @override
  String toString() => 'AdvanceBotTurnResultState(version: $version, gameId: $gameId, scenario: $scenario, dmName: $dmName, players: $players, roomPhase: $roomPhase, endsAt: $endsAt, turnIndex: $turnIndex, round: $round, phase: $phase, dc: $dc, lastRoll: $lastRoll, log: $log, inventory: $inventory, options: $options)';
}
...
;
  ...
  String toJson() => name;
  static ApiCreateGameInputFillMode fromJson(String json) => values.byName(json);
}
...
class GetConstantsResultClassMeta {
  ...
  @override
  String toString() => 'GetConstantsResultClassMeta(name: $name, color: $color, actions: $actions)';
}
...
class GetStateResultViewer {
  ...
  @override
  String toString() => 'GetStateResultViewer(userId: $userId, mySeatId: $mySeatId, spectator: $spectator)';
}
...
class GetStateResultPlayers {
  ...
  @override
  String toString() => 'GetStateResultPlayers(id: $id, name: $name, classKey: $classKey, sprite: $sprite, color: $color, seat: $seat, isHuman: $isHuman, userId: $userId, hp: $hp, slot: $slot)';
}
...
class GetStateResultLog {
  ...
  @override
  String toString() => 'GetStateResultLog(kind: $kind, who: $who, text: $text, color: $color)';
}
...
;
  ...
  String toJson() => name;
  static ListGamesResultMembersSeat fromJson(String json) => values.byName(json);
}
...
class ListGamesResultMembers {
  ...
  @override
  String toString() => 'ListGamesResultMembers(name: $name, classKey: $classKey, seat: $seat)';
}
...
;
  ...
  String toJson() => name;
  static TakeActionResultPlayersSeat fromJson(String json) => values.byName(json);
}
...
class TakeActionResultPlayers {
  ...
  @override
  String toString() => 'TakeActionResultPlayers(id: $id, name: $name, classKey: $classKey, sprite: $sprite, color: $color, seat: $seat, isHuman: $isHuman, userId: $userId, hp: $hp, slot: $slot)';
}
...
class TakeActionResultLog {
  ...
  @override
  String toString() => 'TakeActionResultLog(kind: $kind, who: $who, text: $text, color: $color)';
}
...
class AdvanceBotTurnResult {
  ...
  factory AdvanceBotTurnResult.fromJson(Map<String, dynamic> json) {
    return AdvanceBotTurnResult(
      state: AdvanceBotTurnResultState.fromJson(json['state'] as Map<String, dynamic>),
  ...
  @override
  String toString() => 'AdvanceBotTurnResult(state: $state, botActed: $botActed, botTurnPending: $botTurnPending)';
}
...
class ApiCreateGameInput {
  ...
  factory ApiCreateGameInput.fromJson(Map<String, dynamic> json) {
    return ApiCreateGameInput(
      ...
      fillMode: json['fillMode'] != null ? ApiCreateGameInputFillMode.fromJson(json['fillMode'] as String) : null,
    );
  }
  ...
  @override
  int get hashCode => Object.hash(scenario, dmType, isPublic, accessCode, fillMode);

  @override
  String toString() => 'ApiCreateGameInput(scenario: $scenario, dmType: $dmType, isPublic: $isPublic, accessCode: $accessCode, fillMode: $fillMode)';
}
...
class CreateGameResult {
  ...
  @override
  String toString() => 'CreateGameResult(gameId: $gameId, accessCode: $accessCode)';
}
...
class GetCharacterResult {
  ...
  @override
  String toString() => 'GetCharacterResult(userId: $userId, name: $name, classKey: $classKey, spriteId: $spriteId, sprite: $sprite)';
}
...
class GetChatHistoryResult {
  ...
  factory GetChatHistoryResult.fromJson(Map<String, dynamic> json) {
    return GetChatHistoryResult(
      ...
      color: json['color'] as String,
      text: json['text'] as String,
      kind: json['kind'] != null ? GetChatHistoryResultKind.fromJson(json['kind'] as String) : null,
    );
  }
  ...
  @override
  String toString() => 'GetChatHistoryResult(gameId: $gameId, ts: $ts, who: $who, color: $color, text: $text, kind: $kind)';
}
...
class GetConstantsResult {
  ...
  factory GetConstantsResult.fromJson(Map<String, dynamic> json) {
    return GetConstantsResult(
      ...
      classMeta: (json['classMeta'] as Map<String, dynamic>).map((k, v) => MapEntry(k, v as GetConstantsResultClassMeta)),
    );
  }
  ...
  @override
  String toString() => 'GetConstantsResult(scenarios: $scenarios, dmTypes: $dmTypes, classMeta: $classMeta)';
}
...
class GetStateResult {
  ...
  factory GetStateResult.fromJson(Map<String, dynamic> json) {
    return GetStateResult(
      viewer: GetStateResultViewer.fromJson(json['viewer'] as Map<String, dynamic>),
      gameId: json['gameId'] as String,
      scenario: json['scenario'] as String,
      dmName: json['dmName'] as String,
      players: (json['players'] as List<dynamic>).map((e) => GetStateResultPlayers.fromJson(e as Map<String, dynamic>)).toList(),
      ...
      dc: json['dc'] as num,
      lastRoll: json['lastRoll'] != null ? AdvanceBotTurnResultStateLastRoll.fromJson(json['lastRoll'] as Map<String, dynamic>) : null,
      log: (json['log'] as List<dynamic>).map((e) => GetStateResultLog.fromJson(e as Map<String, dynamic>)).toList(),
      inventory: (json['inventory'] as List<dynamic>).cast<String>(),
      options: (json['options'] as List<dynamic>).cast<String>(),
      version: json['version'] as num,
    );
  ...
  @override
  int get hashCode => Object.hash(viewer, gameId, scenario, dmName, players, roomPhase, endsAt, turnIndex, round, phase, dc, lastRoll, log, inventory, options, version);

  @override
  String toString() => 'GetStateResult(viewer: $viewer, gameId: $gameId, scenario: $scenario, dmName: $dmName, players: $players, roomPhase: $roomPhase, endsAt: $endsAt, turnIndex: $turnIndex, round: $round, phase: $phase, dc: $dc, lastRoll: $lastRoll, log: $log, inventory: $inventory, options: $options, version: $version)';
}
...
class ListGamesResult {
  ...
  factory ListGamesResult.fromJson(Map<String, dynamic> json) {
    return ListGamesResult(
      ...
      members: (json['members'] as List<dynamic>).map((e) => ListGamesResultMembers.fromJson(e as Map<String, dynamic>)).toList(),
    );
  }
  ...
  @override
  int get hashCode => Object.hash(id, name, theme, note, maxParty, dmLevel, dm, finished, full, status, party, partyClasses, members);

  @override
  String toString() => 'ListGamesResult(id: $id, name: $name, theme: $theme, note: $note, maxParty: $maxParty, dmLevel: $dmLevel, dm: $dm, finished: $finished, full: $full, status: $status, party: $party, partyClasses: $partyClasses, members: $members)';
}
...
class ApiSaveCharacterInput {
  ...
  @override
  String toString() => 'ApiSaveCharacterInput(name: $name, classKey: $classKey, spriteId: $spriteId, sprite: $sprite)';
}
...
class TakeActionResult {
  ...
  factory TakeActionResult.fromJson(Map<String, dynamic> json) {
    return TakeActionResult(
      ...
      scenario: json['scenario'] as String,
      dmName: json['dmName'] as String,
      players: (json['players'] as List<dynamic>).map((e) => TakeActionResultPlayers.fromJson(e as Map<String, dynamic>)).toList(),
      roomPhase: TakeActionResultRoomPhase.fromJson(json['roomPhase'] as String),
      endsAt: json['endsAt'] as num?,
      turnIndex: json['turnIndex'] as num,
      round: json['round'] as num,
      ...
      dc: json['dc'] as num,
      lastRoll: json['lastRoll'] != null ? AdvanceBotTurnResultStateLastRoll.fromJson(json['lastRoll'] as Map<String, dynamic>) : null,
      log: (json['log'] as List<dynamic>).map((e) => TakeActionResultLog.fromJson(e as Map<String, dynamic>)).toList(),
      inventory: (json['inventory'] as List<dynamic>).cast<String>(),
      options: (json['options'] as List<dynamic>).cast<String>(),
    );
  }
  ...
  @override
  String toString() => 'TakeActionResult(version: $version, gameId: $gameId, scenario: $scenario, dmName: $dmName, players: $players, roomPhase: $roomPhase, endsAt: $endsAt, turnIndex: $turnIndex, round: $round, phase: $phase, dc: $dc, lastRoll: $lastRoll, log: $log, inventory: $inventory, options: $options)';
}
...
class ApiApi {
  ...
  Future<CreateGameResult> createGame({required ApiCreateGameInput input}) async {
    final params = <String, dynamic>{
      'input': input.toJson(),
    };
  ...
  Future<GetCharacterResult?> getCharacter() async {
    ...
    return result == null ? null : GetCharacterResult.fromJson(result as Map<String, dynamic>);
  }

  Future<RealtimeChannel<dynamic>> getChatChannel({required String gameId}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
    };
  ...
  Future<List<GetChatHistoryResult>> getChatHistory({required String gameId}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
    };
    final result = await _client.call('api.getChatHistory', params);
    return (result as List<dynamic>).map((e) => GetChatHistoryResult.fromJson(e as Map<String, dynamic>)).toList();
  }
  ...
  Future<RealtimeChannel<dynamic>> getStateChannel({required String gameId}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
    };
  ...
  Future<RealtimeChannel<dynamic>> getThinkingChannel({required String gameId}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
    };
  ...
  Future<List<ListGamesResult>> listGames() async {
    ...
    return (result as List<dynamic>).map((e) => ListGamesResult.fromJson(e as Map<String, dynamic>)).toList();
  }

  Future<GetCharacterResult> saveCharacter({required ApiSaveCharacterInput input}) async {
    final params = <String, dynamic>{
      'input': input.toJson(),
    };
  ...
  Future<SendChatResult> sendChat({required String gameId, required String text}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
      'text': text,
    };
  ...
  Future<TakeActionResult> takeAction({required String gameId, required String action}) async {
    final params = <String, dynamic>{
      'gameId': gameId,
      'action': action,
    };
...
class AuthState {
  ...
  @override
  int get hashCode => Object.hash(state, user, actions, error, errorName, retriable);
...
class AuthApiApi {
  ...
  Future<AuthState> getAuthState() async {
    final result = await _client.call('authApi.getAuthState', <String, dynamic>{});
...
class Servers {
  static const String production = 'https://zbyz47p3l0.execute-api.us-east-1.amazonaws.com/prod/aws-blocks/api';
}
...
class Blocks {
  ...
  Blocks({String? baseUrl, SessionStore? sessionStore}) {
    final client = BlocksClient(baseUrl: baseUrl ?? Servers.production, sessionStore: sessionStore);
    api = ApiApi(client);
