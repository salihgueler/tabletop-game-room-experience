/**
 * Backend — aws-blocks/index.ts  (MODULE 06 — Realtime: fakeChannel → Realtime)
 *
 ...
 *
 * The frontend already subscribes to all three (and falls back to polling if a
 * channel is down), so this module is a pure drop-in upgrade: turns and chat now
 * appear LIVE for every player, instead of only after a manual refresh.
 *
 * Still mocked (modules 07–08 replace this):
 *   - AI .................... canned narration  → Agent
 *
